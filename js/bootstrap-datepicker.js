		...
		keydown: function(e){
			...
			switch(e.keyCode){
				...
				case 39: // right
					...
					if (e.ctrlKey){
						newDate = DPGlobal.moveYear(this.date, dir);
						newViewDate = DPGlobal.moveYear(this.viewDate, dir);
					} else if (e.shiftKey){
						newDate = DPGlobal.moveMonth(this.date, dir);
						newViewDate = DPGlobal.moveMonth(this.viewDate, dir);
					} else {
